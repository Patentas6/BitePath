...
import { Home, BookOpenText, CalendarDays, ListChecks, Sparkles, Brain } from 'lucide-react'; // Import Brain icon
...
const navLinks = [
  ...
  { name: 'AI Meal', path: '/ai-meal', icon: Brain }, // Add AI Meal link
];
